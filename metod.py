...
def get_service_sacc():
    ...
    account-first@ambient-inquiry-327412.iam.gserviceaccount.com
    :return:
    """
...
sheet_id = "1Nu_C7xpZIDC5XqY2QAZhy6MPmyv9bSbhe_dXI0Jvm8M"

# https://developers.google.com/sheets/api/reference/rest/v4/spreadsheets.values/get
resp = sheet.values().get(spreadsheetId=sheet_id, range="Лист1!A3:A9").execute()
